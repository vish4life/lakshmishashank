...
intern =[
    {
        ...
        'imgsr': asset_url +  asset_url + 'internships/anzeon.png',
    ...
    },
    {
        ...
        'imgsr': asset_url + 'internships/hal.png',
    ...
    },
    {
        ...
        'imgsr': asset_url + 'internships/air.svg',
...
proj = [
    {
        ...
        'imgsr': asset_url + 'projects/particles.png',
    ...
    },
    {
        ...
        'descr':'JS, HTML, CSS \nCanvas',
        'types':'Generative Art App',
        'imgsr': asset_url + 'projects/birds.png',
        'url':'https://github.com/vish4life/acodeofarts'
    },
    {
        ...
        'types':'Web App',
        'imgsr': asset_url + 'projects/reactfe.jpg',
    ...
    },
    {
        ...
        'descr':'ReactJS, HTML, CSS \n ',
        'types':'Web App',
        'imgsr': asset_url + 'projects/fullstack.jpeg',
    ...
    },
    {
        ...
        'descr':'ReactJS, HTML, CSS \nDjango, Postgres',
        'types':'Web App',
        'imgsr': asset_url + 'projects/crypto.png',
    ...
    },
    {
        ...
        'descr':'Ptyhon (Flet) \n ',
        'types':'Web App',
        'imgsr': asset_url + 'projects/portfolio.png',
        'url':'https://github.com/vish4life/acodeofarts'
    },
    {
        'title':'Peach House',
        ...
        'types':'Mobile App',
        'imgsr': asset_url + 'projects/reactexpoph.png',
    ...
    },
    {
        ...
        'types':'Mobile App',
        'imgsr': asset_url + 'projects/todo.png',
    ...
    },
    {
        ...
        'types':'Mobile App',
        'imgsr': asset_url + 'projects/boltvault.png',
    ...
    },
    {
        ...
        'descr':'ReactNative, CSS \nDjango, Sqlite',
        'types':'Mobile App',
        'imgsr': asset_url + 'projects/yoquiz.png',
    ...
    },
    {
        ...
        'imgsr': asset_url + 'projects/rag.jpg',
    ...
    },
    {
        ...
        'types':'Generative AI App',
        'imgsr': asset_url + 'projects/iva.png',
...
stack =[
    {
        'detls':'HTML',
        'imgsr': asset_url + 'lang/html.png',
        'type':'lang'
    },
    {
        'detls':'CSS',
        'imgsr': asset_url + 'lang/css.png',
        'type':'lang'
    },
    {
        'detls':'JS',
        'imgsr': asset_url + 'lang/js.png',
        'type':'lang'
    },
    {
        'detls':'REACT',
        'imgsr': asset_url + 'lang/react.png',
        'type':'lang'
    },
    {
        'detls':'PYTHON',
        'imgsr': asset_url + 'lang/python.png',
        'type':'lang'
    },
    {
        'detls':'DJANGO',
        'imgsr': asset_url + 'lang/django.png',
        'type':'lang'
    },
    {
        'detls':'FASTAPI',
        'imgsr': asset_url + 'lang/fastapi.png',
        'type':'lang'
    },
    {
        'detls':'FLET',
        'imgsr': asset_url + 'lang/flet.png',
        'type':'lang'
    },
    {
        'detls':'SQL',
        'imgsr': asset_url + 'lang/sql.png',
        'type':'lang'
    },
    {
        'detls':'XML',
        'imgsr': asset_url + 'lang/xml.png',
        'type':'lang'
    },
    {
        'detls':'JSON',
        'imgsr': asset_url + 'lang/json.png',
        'type':'lang'
    },
    {
        'detls':'VSCODE',
        'imgsr': asset_url + 'tools/vscode.png',
        'type':'tool'
    },
    {
        'detls':'VSTUDIO',
        'imgsr': asset_url + 'tools/vstudio.png',
        'type':'tool'
    },
    {
        'detls':'TEAMS',
        'imgsr': asset_url + 'tools/teams.png',
        'type':'tool'
    },
    {
        'detls':'EXCEL',
        'imgsr': asset_url + 'tools/excel.png',
        'type':'tool'
    },
    {
        'detls':'WORD',
        'imgsr': asset_url + 'tools/word.png',
        'type':'tool'
    },
    {
        'detls':'POWERPOINT',
        'imgsr': asset_url + 'tools/powerpoint.png',
        'type':'tool'
    },
    {
        'detls':'AWS',
        'imgsr': asset_url + 'tools/aws.png',
        'type':'tool'
    },
    {
        'detls':'ORACLECLOUD',
        'imgsr': asset_url + 'tools/oci.png',
        'type':'tool'
    },
    {
        'detls':'MYSQL',
        'imgsr': asset_url + 'tools/mysql.png',
        'type':'tool'
    },
    {
        'detls':'JENKINS',
        'imgsr': asset_url + 'tools/jenkins1.png',
        'type':'tool'
    },
    {
        'detls':'GITHUB',
        'imgsr': asset_url + 'tools/github.png',
        'type':'tool'
    },
    {
        'detls':'XCODE',
        'imgsr': asset_url + 'tools/xcode.png',
        'type':'tool'
    },
    {
        'detls':'INSOMNIA',
        'imgsr': asset_url + 'tools/insomnia1.png',
        'type':'tool'
    },
    {
        'detls':'OLLAMA',
        'imgsr': asset_url + 'tools/ollama.png',
        'type':'tool'
    },
    {
        'detls':'COPILOT',
        'imgsr': asset_url + 'tools/copilot.png',
        'type':'tool'
    },
    {
        'detls':'CLAUDE',
        'imgsr': asset_url + 'tools/claude.png',
        'type':'tool'
    },
    {
        'detls':'ANTIGRAVITY',
        'imgsr': asset_url + 'tools/antigravity.png',
        'type':'tool'
    },
    {
        'detls':'POSTGRES',
        'imgsr': asset_url + 'tools/postgre.png',
        'type':'tool'
    },
]
certs = [
    {
        ...
        'imgsr': asset_url + 'certs/ocigenaipro.png',
        'type':'cert',
    ...
    },
    {
        ...
        'imgsr': asset_url + 'certs/ocivector.png',
        'type':'cert' ,
    ...
    },
    {
        ...
        'imgsr': asset_url + 'certs/ociaiassoc.png',
        'type':'cert',
    ...
    },
    {
        ...
        'imgsr': asset_url + 'certs/ocicloudassoc.png',
        'type':'cert' ,
